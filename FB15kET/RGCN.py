...
class RGCN(nn.Module):
    def __init__(self, embedding_dim, num_nodes, num_rels, num_types,
        ...
        self.proj_head = nn.Sequential(nn.Linear(self.embedding_dim, self.num_types), nn.ReLU(inplace=True),
                                       nn.Linear(self.num_types, self.num_types))
